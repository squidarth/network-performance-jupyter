...
python3 experiments.py --hyperparameters-file hyperparameters_3.json --experiment-name 3
echo "Starting experiment 4"
python3 experiments.py --hyperparameters-file hyperparameters_4.json --experiment-name 4
